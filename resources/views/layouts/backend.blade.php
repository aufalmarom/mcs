        ...
        <div class="main-panel">
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2019 <a href="https://aufalmarom.id/" target="_blank">aufalmarom.id</a></span>
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center">Made with <i class="mdi mdi-heart text-danger"></i> by <a href="https://aufalmarom.id/" target="_blank">aufalmarom.id</a></span>
            </div>
          </footer>
          <!-- partial -->
        </div>
